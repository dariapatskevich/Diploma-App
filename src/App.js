...
import { DateComponent } from "./Data/DataComponent";
...
function App() {
	...
	const addPost = (post) => {
		const updatedPost = { ...post, likeCount: 0 };

		localStorage.setItem("data", JSON.stringify([...posts, updatedPost]));
